...
def conv2d(inputs,
  ...
  with tf.variable_scope(scope, reuse=reuse) as sc:
      ...
      #                        padding=padding,
      #                        data_format=data_format)
      outputs = tf.contrib.layers.conv2d(inputs, num_output_channels, kernel_size, stride=stride, padding=padding,
                                         data_format=data_format, activation_fn=None, normalizer_fn=None,
                                         weights_initializer=tf.contrib.layers.xavier_initializer(),
                                         scope=scope, reuse=reuse, biases_initializer=tf.zeros_initializer())
...
def batch_norm_template_unused(inputs, is_training, scope, moments_dims, bn_decay, reuse=False):
