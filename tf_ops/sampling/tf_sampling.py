...
if __name__=='__main__':
    ...
    with tf.device('/gpu:1'):
        ...
        # print 'pt_sample: ', pt_sample    # original
        print('pt_sample: ', pt_sample)     # Bernardo (for python 3.7)
        reduced_sample=gather_point(pt_sample,farthest_point_sample(1024,pt_sample))
        # print reduced_sample   # original
        print(reduced_sample)    # Bernardo (for python 3.7)
    with tf.Session('') as sess:
        ret=sess.run(reduced_sample)
    # print ret.shape,ret.dtype   # original
    print(ret.shape,ret.dtype)    # Bernardo (for python 3.7)
