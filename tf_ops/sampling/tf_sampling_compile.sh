...
# Bernardo
g++ -std=c++14 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I $TF_INC -I $TF_INC/external/nsync/public -I $CUDA_HOME/include -lcudart -L $CUDA_HOME/lib64/ -O2 -D_GLIBCXX_USE_CXX11_ABI=0
