...
parser.add_argument('--num_point', type=int, default=18500, help='Point Number [default: 1024]')     # Bernardo
...
# if FLAGS.normal:
    # assert(NUM_POINT<=10000)  # Bernardo
DATA_PATH = os.path.join(ROOT_DIR, '../data/FRGCv2.0/FRGC-2.0-dist')
TRAIN_DATASET = frgc2_dataset.FRGCv2_Dataset(root=DATA_PATH, npoints=NUM_POINT, split='train', normalize=True, normal_channel=FLAGS.normal, batch_size=BATCH_SIZE)
TEST_DATASET  = frgc2_dataset.FRGCv2_Dataset(root=DATA_PATH, npoints=NUM_POINT, split='test', normalize=True, normal_channel=FLAGS.normal, batch_size=BATCH_SIZE)
# else:
...
def train():
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str(GPU_INDEX)):
            pointclouds_pl, labels_pl = MODEL.placeholder_inputs(BATCH_SIZE, NUM_POINT)                                  # original
            # pointclouds_pl, labels_pl = MODEL.placeholder_inputs(BATCH_SIZE, NUM_POINT, TRAIN_DATASET.num_channel())   # Bernardo
...
def train_one_epoch(sess, ops, train_writer):
    ...
    while TRAIN_DATASET.has_next_batch():
        ...
        # print 'train_face_recognition.py: train_one_epoch():'
        # print '    batch_data:', batch_data
        # print '    batch_label:', batch_label
        # print '    ops[\'merged\']:', ops['merged']
        # print '    ops[\'step\']:', ops['step']
        # print '    ops[\'train_op\']:', ops['train_op']
        # print '    ops[\'loss\']:', ops['loss']
        # print '    ops[\'pred\']:', ops['pred']
        summary, step, _, loss_val, pred_val = sess.run([ops['merged'], ops['step'],
            ops['train_op'], ops['loss'], ops['pred']], feed_dict=feed_dict)
        # print '    summary:', summary
        # print '    step:', step
        # print '    cur_batch_data:', cur_batch_data
        # print '    cur_batch_label:', cur_batch_label
        # print '    is_training:', is_training
        # print '    loss_val:', loss_val    # NAN IS PRINTED HERE
        # print '    pred_val:', pred_val    # NAN IS PRINTED HERE
...
def eval_one_epoch(sess, ops, test_writer):
    ...
    while TEST_DATASET.has_next_batch():
        ...
        # print 'train_face_recognition.py: eval_one_epoch():'
        # print '    cur_batch_data:', cur_batch_data
        # print '    cur_batch_label:', cur_batch_label
        # print '    is_training:', is_training 
        feed_dict = {ops['pointclouds_pl']: cur_batch_data,
