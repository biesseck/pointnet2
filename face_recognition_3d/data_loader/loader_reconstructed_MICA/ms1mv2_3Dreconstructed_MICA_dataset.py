...
class MS1MV2_3D_Reconstructed_MICA_Dataset():
    def __init__(self, root, batch_size = 32, npoints = 2900, min_samples=3, max_samples=-1, split='train', normalize=True, normal_channel=False, modelnet10=False, cache_size=15000, shuffle=None):
        self.root = root
        ...
        subjects_with_pc_paths, unique_subjects_names, samples_per_subject = TreeMS1MV2_3DReconstructedMICA().load_filter_organize_pointclouds_paths(self.root, file_ext, min_samples, max_samples)
